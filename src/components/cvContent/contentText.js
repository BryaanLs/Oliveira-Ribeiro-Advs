const texts = [
  {
    gabriel: {
      name: "Gabriel Lara de Oliveira Ribeiro",
      span: "(OAB/SP 449.575)",
      profile: [
        "Advogado pela Fundação Armando Alvares Penteado de São Paulo/SP;",
        "Pós-graduando em Direito Empresarial, na FGV/SP.",
        "Legal intern e posteriormente advogado Jr. no Escritório Ferreira Britto Advogados na área de direito imobiliário;",
      ],
      activity: [
        "Direito Empresarial",
        "Contratos",
        "Imobiliário",
        "Consumidor (bancários)",
      ],
    },
  },
  {
    maria: {
      name: "Maria Cláudia de Abreu Assis ",
      span: "(OAB/MT 29.138-O)",
      profile: [
        "Advogada pela Fundação Armando Alvares Penteado de São Paulo/SP",
        "Atuou como estagiária da Procuradoria de Justiça de Direitos Difusos e Coletivos do Ministério Público do Estado de São Paulo",
        "Legal intern dos escritórios Almeida Law Advogados e Vezzi Lapolla Mesquita Advogados em São Paulo/SP",
        "Prática jurídica com ênfase em Direito de Família, Consumidor e Serventias Extrajudiciais",
      ],
      activity: ["Regularização fundiária", "Inventário", "Ação de despejo"],
    },
  },
  {
    diene: {
      name: "Diene Ellen Abib Chemim Scarfone",
      span: "(OAB/SP 461.237)",
      profile: [
        "Advogada pela Fundação Armando Alvares Penteado de São Paulo/SP",
  ...
  {
    aurea: {
      name: "Áurea Aparecida Colaço da Silva",
      span: "(OAB/SP 129.218)",
      profile: [
        "Advogada pela Instituição Antônio Eufrásio de Toledo de Presidente Prudente",
        "Pós-graduada em Direito Administrativo pela PUC/SP e Direito do Trabalho pela Instituição Toledo de Bauru/SP",
